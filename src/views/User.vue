                ...
                <div class="collection-wrap">
                    ...
                    <div class="collection">
                        ...
                        <card-img class="card-imgs" v-for="item in collectionPlayList" :key="item.id"
                            ...
                            @click.native="showMyCollection(item)"></card-img>
                    </div>
                </div>
            </div>
        </div>
        <div class="show-album-detail">
            <albumDetail v-if="albumShow" :albumDetailData="albumDescription" :albumList="albumList"
                @showAlbum="playShowHandler" :backForwardShow="playViewShow" @scroll="handeleScroll(e)" :showMore="true"
                @showMoreHandler="showMoreHandler"></albumDetail>
...
export default {
    data() {
        ...
        beforeunloadHandler(e) {
            ...
            if (this.userID != null) {
                this.axios.get(`/user/detail?uid=${this.userID}`).then(result => {
